...
export const broadcastToProject = (req: any, projectSlug: any, event: any, data: any) => {
...
const getNotificationMessage = (task: any, action: any, updaterName: any) => {
...
const notifyAssigneeOfUpdate = async (req: any, task: any, oldTask: any, actionType: any) => {
  try {
    const io = req.app.get('io');
    if (!io) return;
...
export const broadcastTaskStatusChange = (req: any, projectSlug: any, task: any, oldTask: any) => {
...
export const broadcastCommentAdded = async (req: any, projectSlug: any, comment: any) => {
...
export const broadcastTaskAssigned = (req: any, projectSlug: any, task: any, oldTask: any) => {
...
export const broadcastTaskCreated = (req: any, projectSlug: any, task: any) => {
  broadcastToProject(req, projectSlug, 'task:created', task);
};

// Broadcasts when a task is deleted
export const broadcastTaskDeleted = (req: any, projectSlug: any, taskId: any) => {
  broadcastToProject(req, projectSlug, 'task:deleted', { taskId });
};

// Broadcasts when a task is updated (e.g. title, desc, priority, etc)
export const broadcastTaskUpdated = (req: any, projectSlug: any, task: any, oldTask: any) => {
...
export const broadcastCommentUpdated = (req: any, projectSlug: any, comment: any) => {
  broadcastToProject(req, projectSlug, 'comment:updated', comment);
};

// Broadcasts when a comment is deleted
export const broadcastCommentDeleted = (req: any, projectSlug: any, commentId: any) => {
