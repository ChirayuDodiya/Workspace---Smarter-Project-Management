...
import { listProjects, createProject, showProject, updateProject, deleteProject, projectStats, listTasks, createTask, teamMembers, listManagers, addTeamMember, removeTeamMember, exportProjectTasks, } from '../controllers/project/project.controller.js';
...
router.put('/:slug', authMiddleware, loadProjectBySlug, validateUpdateProject, ProjectPolicy.canUpdate, updateProject);
...
router.post('/:slug/tasks', authMiddleware, loadProjectBySlug, validateCreateTask, TaskPolicy.canCreate, createTask);
router.get('/:slug/team-members', authMiddleware, loadProjectBySlug, etagMiddleware, teamMembers);
router.post('/:slug/team-members', authMiddleware, loadProjectBySlug, ProjectPolicy.canUpdate, addTeamMember);
router.delete('/:slug/team-members/:userId', authMiddleware, loadProjectBySlug, ProjectPolicy.canUpdate, removeTeamMember);
