...
const updateComment = asyncHandler(async (req, res) => {
    ...
    broadcastCommentUpdated(req, comment.tasks.projects.slug, serializeComment({ ...updatedComment, user: updatedComment.users }));
    return successResponse(res, serializeComment({ ...updatedComment, user: updatedComment.users }), 'Comment updated successfully');
});
