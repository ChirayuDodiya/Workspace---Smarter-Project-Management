...
export function ChangePassword() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const msg = axiosError.response?.data?.message || 'Failed to change password. Please check your current password and try again.';
      setServerError(msg);
    }
  };

  return (
    <div className="w-full h-full flex justify-center items-start pt-12 sm:pt-20 px-4">
      <div className="w-full max-w-lg bg-[#181818] border border-zinc-800/80 rounded-2xl shadow-xl p-8 sm:p-10 flex flex-col">
