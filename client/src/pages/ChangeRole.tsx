    ...
    <main className="p-4 sm:p-8 text-white min-h-full bg-[#121212] select-none">
      <div className="max-w-3xl mx-auto space-y-6 sm:space-y-8 text-left">
        ...
        <div className="space-y-4 pt-4">
          ...
          <div className="hidden sm:flex items-center gap-6 pr-30">
              ...
              <>
                {users.map((u) => {
                  ...
                  return (
                    <div
                      key={u.id}
                      className={`flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-6 py-4 sm:py-3 px-4 sm:px-6 hover:bg-[#1a1a1a] rounded-2xl transition-all duration-150 ${
                ...
                {hasMore && !isLoading && (
                  <div className="flex justify-center pt-8 pb-12 sm:pr-14">
                    <button
